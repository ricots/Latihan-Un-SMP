...
public class EngkungsMatematikaDua extends Fragment
{
private Context ly;
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		View engkungs=inflater.inflate(R.layout.engkungs_matematika_two,container,false);
		WebView bi=(WebView)engkungs.findViewById(R.id.engkungs_material_mtk_two);
		WebSettings st=bi.getSettings();
		st.setJavaScriptEnabled(true);
		st.setSupportZoom(true);
		bi.requestFocusFromTouch();
	    bi.loadUrl ("file:///android_asset/engkungs_material_matematika_kunci_jawaban.html");
