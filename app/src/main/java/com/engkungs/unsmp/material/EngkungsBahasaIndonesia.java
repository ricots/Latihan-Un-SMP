...
public class EngkungsBahasaIndonesia extends Fragment
{
	private Context ly;
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		inflate(R.layout.engkungs_bahasa_indonesia,
		container,
		false);
		WebView bi=(WebView)engkungs.findViewById(R.id.engkungs_material_bi);
		WebSettings st=bi.getSettings();
		st.setJavaScriptEnabled(true);
		st.setSupportZoom(true);
		bi.requestFocusFromTouch();
	    bi.loadUrl ("file:///android_asset/engkungs_material_bahasa_indonesia.html");
